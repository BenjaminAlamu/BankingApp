...
{
    /// <summary>
    /// The Savings Account class, it inherits from the Abstract Class Account
    /// </summary>
    /// <seealso cref="My_Banking_App.Account" />
    class SavingsAccount : Account
    {
        /// <summary>
        /// This is the maximum balance the account can have
        /// </summary>
        public readonly double MAXBALANCE = 10000000;

        /// <summary>
        /// This is the minimum balance the account can have
        /// </summary>
        private readonly double MINBALANCE = 1000;

        /// <summary>
        /// This is the maximum amount this account can withdraw
        /// </summary>
        private readonly double MAXWITHDRAWAL = 1000000;

        /// <summary>
        /// This is the amount that can be deposited into the account
        /// </summary>
        private readonly double MAXDEPOSIT = 1000000;

        /// <summary>
        /// This is the maximum amount that can be transfered from the account
        /// </summary>
        private readonly double MAXTRANSFER = 1000000;
        ...
        {
            {
                ...
                { //Check if amount to be deposited is not more than the maximum allowed deposit
                    Console.WriteLine("The amount {0} you are trying to deposit is more than maximum amount you are allowed to deposit which is {1}", amount, MAXDEPOSIT);
                }
        ...
        /// Transfers the money.
        /// </summary>
        /// <param name="toAccount">The account to which the money is sent.</param>
        /// <param name="amount">The amount to be deposited.</param>
